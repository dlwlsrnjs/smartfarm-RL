...
if __name__ == "__main__":
    ...
    # Only override dates for the default research benchmark configs
    if args.env_config_name in ["train_eval_set", "5min_four_controls", "15min_four_controls", "5min_time", "5min_time_pred_hor", "5min_time_hor_5hr"]:
